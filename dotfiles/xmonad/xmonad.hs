...
-- -------------------------------------------------------------------------------------------------
-- Workspaces
myWorkspaces = ["1","2","3","4","5","6","7","9","10"]
...
myConfig = def
     ...
     , workspaces         = myWorkspaces   -- Names of workspaces
     , focusFollowsMouse  = True           -- Mouse focuses windows
     , clickJustFocuses   = True           -- Don't pass click to window, only focus it
     }
