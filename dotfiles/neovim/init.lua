...
vim.keymap.set('n', '<space>x', '<cmd>NvimTreeToggle<cr>', { desc = 'Toggle Tree' })
...
--   hi LineNr guibg=#171717
--   hi LineNr guifg=#4a4a4a
--   hi String guifg=#9ea55c
-- ]]

-- vim.cmd[[ 
--   silent! colorscheme meh 
--   hi Type guifg=#ae90b7
-- ]]
...
require('nvim-treesitter.configs').setup({
  ...
  ensure_installed = { "lua", "javascript", "typescript", "tsx", "json", "css", "haskell" },
